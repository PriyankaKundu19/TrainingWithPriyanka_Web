...
<?php include 'inc/sidebar.php' ?>
    ...
    if (empty($file_name)|| empty($title)|| empty($cat)||empty($body)||empty($tags)||empty($author)) {
     ...
     .implode(', ', $permited)."</span>";
        ...
        $query = "INSERT INTO post(cat,title,body,image,author,tags,userid) 
                    ...
                    <table class="form">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td>
                                <input name="tags" type="text" placeholder="Enter Tags Name..." class="medium" />
                            </td>
                        </tr>
                          <tr>
                            <td>
