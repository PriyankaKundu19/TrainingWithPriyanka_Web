    ...
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft logo">
                    <img src="img/pk.jpg" alt="Logo" />
				</div>
				<div class="floatleft middle">
					<h1>Training with Priyanka</h1>
					<p>www.priyankawithliveproject.com</p>
				</div>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-charts"><a href="adduser.php"><span>Add Users</span></a></li>
            <?php } ?>
